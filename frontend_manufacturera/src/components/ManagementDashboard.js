...
const ManagementDashboard = () => {
    const [overallProfitLossData, setOverallProfitLossData] = useState({ overall_profit_loss: 0 });
    const [currentBalanceData, setCurrentBalanceData] = useState({ account_balances: [], cash_register_balances: [] });
    const [revenueExpensesData, setRevenueExpensesData] = useState({ total_revenue: 0, total_expenses: 0 });
